...
inline Intersection Triangle::getIntersection(Ray ray)
{
    ...
    inter.normal = this->normal; // FIXME: do not totally understands this in cpp
    inter.distance = t_tmp;
    inter.obj = this; // FIXME: do not totally understands this in cpp
    inter.m = m;

    // std::cout << "inline Intersection Triangle::getIntersection" << std::endl;
